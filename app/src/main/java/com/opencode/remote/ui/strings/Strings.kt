...
val enStrings = AppStrings(
    ...
    moveSession = "Move to Project",
    pinSession = "Pin",
    unpinSession = "Unpin",
    pinnedSection = "Pinned",
    autoDirectPin = "Open pinned on start",
    openLink = "Open link",
    copyLink = "Copy link",
    linkOpenFailed = "Can't open link",
    templateDialogTitle = "Quick Template",
    templateTitleLabel = "Title (chip label)",
    templateContentLabel = "Content (actually sent)",
    diffTitle = "Changes",
    diffEmpty = "No changes",
    compactTitle = "Compact Context",
    shellTitle = "Run Command",
    shellPlaceholder = "Type a command…",
    worktreeTitle = "Worktrees",
    worktreeBranch = "Branch",
    worktreeName = "Name (optional)",
    worktreeNeedRepo = "Requires a Git repository",
...
val zhStrings = AppStrings(
    ...
    unpinSession = "取消置顶",
    pinnedSection = "置顶",
    autoDirectPin = "启动直达置顶",
    openLink = "打开链接",
    copyLink = "复制链接",
    linkOpenFailed = "打不开链接",
    templateDialogTitle = "快捷模板",
    templateTitleLabel = "标题（chip 显示）",
    templateContentLabel = "内容（实际发送）",
    diffTitle = "变更",
    diffEmpty = "暂无变更",
    compactTitle = "压缩上下文",
    shellTitle = "执行命令",
